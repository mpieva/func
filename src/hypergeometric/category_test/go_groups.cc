...
go_groups::go_groups( string &groups, string detected_s, string changed_s, string root_go, int cutoff_ )  
{
...
//	cerr << detected.size() << endl ;
//	cerr << changed_data.size() << endl ;


}


int* go_groups::calculate_data( ostream *os ) 
{
//	int i = -1 ;
	int *ret = new int[10] ;
	for ( int i=0 ; i<10 ; ++i ) {
